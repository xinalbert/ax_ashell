...
pub(super) fn settings_connection_page(
    ...
    SettingPage::new(t!("settings_connections").to_string())
                            ...
                            for (value, label) in [
                                ...
                                items.push(super::fast_menu::FastMenuItem::new(
                                    ...
                                    move |this, _window, cx| {
                                        this.config.set_sftp_transfer_close_behavior(value);
                                        this.config.save_logged("set_sftp_close_behavior");
                                        cx.notify();
                                    },
                                ));
                            }
                            super::fast_menu::fast_settings_menu(
                                "sftp-transfer-close-behavior",
                                label,
                                None,
                                px(220.),
                                None,
