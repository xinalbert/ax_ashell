...
- 已修正上一版回归：鼠标抬起不再立即冲刷积压输出，避免刚形成的终端选区被自己触发的 flush 立刻打掉
...
- 下一步重点验证：`Working` 持续输出时选区是否稳定、中文候选框是否不再被流式输出打断；若底部最后一行仍命中异常，再单独修正 grid bounds 记录

## 最后更新时间

- 2026-07-08 17:19 +0800
